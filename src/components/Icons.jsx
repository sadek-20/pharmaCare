...
export const LayoutDashboard = ({ className }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const Printer = ({ className = "w-6 h-6" }) => (
  <svg
    className={className}
    fill="none"
    viewBox="0 0 24 24"
...
// Add this to your existing Icons component
...
// Add these icons to your existing Icons.jsx file
...
export const MessageCircle = ({ className = "w-6 h-6" }) => (
  <svg
    className={className}
    fill="none"
    viewBox="0 0 24 24"
...
// WhatsApp specific icon (alternative to MessageCircle)
